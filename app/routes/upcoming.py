...
def get_upcoming():
    ...
    if cached_games:
        return success_response(data={"games": cached_games, "source": "cache"})
    ...
    games = igdb.get_upcoming_games(days_ahead=days_ahead, limit=500)
    ...
    return success_response(data={"games": games, "source": "api"})
