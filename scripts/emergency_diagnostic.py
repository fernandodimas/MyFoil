...
def diagnose_file_paths(app):
    ...
    with app.app_context():
        ...
        if missing_count_est > 100:
            ...
            print()
            print("  1. Criar backup do banco AGORA:")
            print("     docker exec -it myfoil sqlite3 app.db '.backup app_backup.db'")
            print()
...
def main():
    ...
    print("   - Criar backup: docker exec -it myfoil sqlite3 app.db '.backup app_backup.db'")
    print()
